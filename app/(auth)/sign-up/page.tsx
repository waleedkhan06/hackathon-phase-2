...
export default function SignUpPage() {
  ...
  const onSubmit = async (data: SignUpFormData) => {
    ...
    try {
      ...
      toast({ title: 'Account Created', description: 'Welcome! Your account has been set up.' });
      router.push('/tasks');
    } catch (err) {
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        ...
        >
            ...
            <div className="p-8 md:p-10">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                >
                  ...
                  {errors.confirmPassword && (
                    <p className="text-red-500 dark:text-red-400 text-sm font-medium">{errors.confirmPassword.message}</p>
                  )}
                </motion.div>
          ...
          >
            ...
            <Link href="/terms" className="underline hover:text-indigo-600 dark:hover:text-indigo-400">Terms of Service</Link>{' '}
            and{' '}
            <Link href="/privacy" className="underline hover:text-indigo-600 dark:hover:text-indigo-400">Privacy Policy</Link>
          </motion.p>
        </motion.div>
      </div>
    </div>
